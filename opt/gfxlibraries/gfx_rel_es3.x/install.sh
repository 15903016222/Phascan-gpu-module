...
# Auto-generated for omap3430_linux from embedded.pj 1.4.14.2616
#

# PVR Consumer services version number
#
PVRVERSION=1.4.14.2616
...
install_pvr()
{
	$DOIT echo "version 1.4.14.2616" >${DISCIMAGE}${DDK_INSTALL_LOG}
	# Install the standard scripts
	#
# 	install_file rc.pvr /etc/init.d/rc.pvr "boot script" a+x
# 
#     #
...
# 	#
# 		install_file pvrsrvkm.ko /lib/modules/$(uname -r)/kernel/drivers/char/pvrsrvkm.ko "kernel module"
# 	if [ "$host" = 1 ]; then
# 			grep -v -e "drivers/char/pvrsrvkm.ko" ${DISCIMAGE}/lib/modules//modules.dep >/tmp/modules.$$.tmp
# 	echo "/lib/modules/$(uname -r)/kernel/drivers/char/pvrsrvkm.ko:" >>/tmp/modules.$$.tmp
# 	cp /tmp/modules.$$.tmp ${DISCIMAGE}/lib/modules//modules.dep
# 	fi
# 
# 
# 
# if [ -z "$NO_DISPLAYMOD" ]; then
# 		install_file omaplfb.ko /lib/modules/$(uname -r)/kernel/drivers/char/omaplfb.ko "kernel module"
# 	if [ "$host" = 1 ]; then
# 			grep -v -e "drivers/char/omaplfb.ko" ${DISCIMAGE}/lib/modules//modules.dep >/tmp/modules.$$.tmp
...
# 		install_file bc_example.ko /lib/modules/$(uname -r)/kernel/drivers/char/bc_example.ko "kernel module"
# 	if [ "$host" = 1 ]; then
# 			grep -v -e "drivers/char/bc_example.ko" ${DISCIMAGE}/lib/modules//modules.dep >/tmp/modules.$$.tmp
...
# 	$DOIT rm -f /tmp/modules.$$.tmp
	...
	#
	install_file libGLES_CM.so /usr/lib/libGLES_CM.so.1.1.14.2616 "shared library"
	install_link libGLES_CM.so.1.1.14.2616 /usr/lib/libGLES_CM.so


	install_file libGLESv2.so /usr/lib/libGLESv2.so.1.1.14.2616 "shared library"
	install_link libGLESv2.so.1.1.14.2616 /usr/lib/libGLESv2.so

	install_file libglslcompiler.so /usr/lib/libglslcompiler.so.1.1.14.2616 "shared library"
	install_link libglslcompiler.so.1.1.14.2616 /usr/lib/libglslcompiler.so

	install_file libOpenVG.so /usr/lib/libOpenVG.so.1.1.14.2616 "shared library"
	install_link libOpenVG.so.1.1.14.2616 /usr/lib/libOpenVG.so
	install_file libOpenVGU.so /usr/lib/libOpenVGU.so.1.1.14.2616 "shared library"
	install_link libOpenVGU.so.1.1.14.2616 /usr/lib/libOpenVGU.so

	install_file libIMGegl.so /usr/lib/libIMGegl.so.1.1.14.2616 "shared library"
	install_link libIMGegl.so.1.1.14.2616 /usr/lib/libIMGegl.so
	install_file libEGL.so /usr/lib/libEGL.so.1.1.14.2616 "shared library"
	install_link libEGL.so.1.1.14.2616 /usr/lib/libEGL.so
	install_file libpvr2d.so /usr/lib/libpvr2d.so.1.1.14.2616 "shared library"
	install_link libpvr2d.so.1.1.14.2616 /usr/lib/libpvr2d.so
	install_file libpvrPVR2D_BLITWSEGL.so /usr/lib/libpvrPVR2D_BLITWSEGL.so.1.1.14.2616 "shared library"
	install_link libpvrPVR2D_BLITWSEGL.so.1.1.14.2616 /usr/lib/libpvrPVR2D_BLITWSEGL.so
	install_file libpvrPVR2D_FLIPWSEGL.so /usr/lib/libpvrPVR2D_FLIPWSEGL.so.1.1.14.2616 "shared library"
	install_link libpvrPVR2D_FLIPWSEGL.so.1.1.14.2616 /usr/lib/libpvrPVR2D_FLIPWSEGL.so

	install_file libsrv_um.so /usr/lib/libsrv_um.so.1.1.14.2616 "shared library"
	install_link libsrv_um.so.1.1.14.2616 /usr/lib/libsrv_um.so
	install_file libPVRScopeServices.so /usr/lib/libPVRScopeServices.so.1.1.14.2616 "shared library"
	install_link libPVRScopeServices.so.1.1.14.2616 /usr/lib/libPVRScopeServices.so
	install_file libpvrPVR2D_X11WSEGL.so /usr/lib/libpvrPVR2D_X11WSEGL.so.1.1.14.2616 "shared library"
	install_link libpvrPVR2D_X11WSEGL.so.1.1.14.2616 /usr/lib/libpvrPVR2D_X11WSEGL.so
	install_file libpvrPVR2D_FRONTWSEGL.so /usr/lib/libpvrPVR2D_FRONTWSEGL.so.1.1.14.2616 "shared library"
	install_link libpvrPVR2D_FRONTWSEGL.so.1.1.14.2616 /usr/lib/libpvrPVR2D_FRONTWSEGL.so
	install_file libpvrPVR2D_LINUXFBWSEGL.so /usr/lib/libpvrPVR2D_LINUXFBWSEGL.so.1.1.14.2616 "shared library"
	install_link libpvrPVR2D_LINUXFBWSEGL.so.1.1.14.2616 /usr/lib/libpvrPVR2D_LINUXFBWSEGL.so
	...
	install_file pvrsrvinit /usr/local/bin/pvrsrvinit "binary" a+x
#	install_file sgx_init_test /usr/local/bin/sgx_init_test "binary" a+x
#
#
#
#	# Install the standard unittests
#	#
#	install_file gles2test1 /usr/local/bin/gles2test1 "binary" a+x
#	install_file glsltest1_vertshader.txt /usr/local/bin/glsltest1_vertshader.txt "shader" a+x
#	install_file glsltest1_fragshaderA.txt /usr/local/bin/glsltest1_fragshaderA.txt "shader" a+x
#	install_file glsltest1_fragshaderB.txt /usr/local/bin/glsltest1_fragshaderB.txt "shader" a+x
#	install_file gles2_texture_stream /usr/local/bin/gles2_texture_stream "binary" a+x
#
#	install_file gles1test1 /usr/local/bin/gles1test1 "binary" a+x
#	install_file gles1_texture_stream /usr/local/bin/gles1_texture_stream "binary" a+x
#	install_file ovg_unit_test /usr/local/bin/ovg_unit_test "binary" a+x
#
#	install_file services_test /usr/local/bin/services_test "binary" a+x
#	install_file sgx_blit_test /usr/local/bin/sgx_blit_test "binary" a+x
#	install_file sgx_flip_test /usr/local/bin/sgx_flip_test "binary" a+x
#	install_file sgx_render_flip_test /usr/local/bin/sgx_render_flip_test "binary" a+x
#	install_file pvr2d_test /usr/local/bin/pvr2d_test "binary" a+x
#	install_file eglinfo /usr/local/bin/eglinfo "binary" a+x
###GLESUNITTEST(egl_test)dnl
###GLES2UNITTEST(gl2info)dnl
###ifelse(SUPPORT_PVR2D,1,[[UNITTEST(pvr2dtest)]])dnl
#
#	install_file xgles1test1 /usr/local/bin/xgles1test1 "binary" a+x
#	install_file xmultiegltest /usr/local/bin/xmultiegltest "binary" a+x
#	install_file xtest /usr/local/bin/xtest "binary" a+x
...
install_X()
{
	...
	for file in ./freedesktop/kdrive//usr/X11R6_SGX/bin/X*; do
		install_file $file /usr/X11R6_SGX/bin/`basename $file` "X11 server" a+x
	done
...
echo
echo "Installing PowerVR Consumer/Embedded DDK 1.4.14.2616 on $from"
echo
